...
for ( sc in SCs ) {
    file <- str_c("prosolo/", sc,".PNG.alt_sites_only.prosolo.min_sc_cov_1.gt_matching.ML_set.tsv")
...
write_tsv(ado_rates, "prosolo/single-cells.PNG.alt_sites_only.prosolo.min_sc_cov_1.ado-rates-against-ground-truth.tsv")
